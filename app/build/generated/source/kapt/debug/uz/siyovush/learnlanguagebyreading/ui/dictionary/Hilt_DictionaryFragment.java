...
public abstract class Hilt_DictionaryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_DictionaryFragment() {
    super();
  }

  Hilt_DictionaryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DictionaryFragment_GeneratedInjector) this.generatedComponent()).injectDictionaryFragment(UnsafeCasts.<DictionaryFragment>unsafeCast(this));
    }
  }
