...
public abstract class Hilt_AddBookFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_AddBookFragment() {
    super();
  }

  Hilt_AddBookFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AddBookFragment_GeneratedInjector) this.generatedComponent()).injectAddBookFragment(UnsafeCasts.<AddBookFragment>unsafeCast(this));
    }
  }
